...
var BankService = (function () {
    ...
    BankService.prototype.getByBankNamRem = function (bankNameRem) {
        this.params.set('bankNameRem', bankNameRem);
        return this.http.get(this.urlBank, { headers: this.headers, search: this.params }).map(function (res) { return res.json(); });
    };
    return BankService;
}());
